...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let response = await fetch('http://localhost:6679/contact',{
            method:'POST',
            headers:{
        ...
        if(result.code === 200){
            setStatus({succes: true, message:'Message Send Succesfully'})
        }else{
            setStatus({succes: false, message: 'Someting went wrong'})
        }
